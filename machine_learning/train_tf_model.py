...
from evaluate_model import reuse_model
pred_100_train = reuse_model(X_train, '/home/anschutzm/Dokumente/TUM/WS1920/Seminar/anschuetz-miriam/machine_learning/models/model100m.tflite')
pred_100_test = reuse_model(X_test, '/home/anschutzm/Dokumente/TUM/WS1920/Seminar/anschuetz-miriam/machine_learning/models/model100m.tflite')
